...
//             <i
//               className="material-icons icon-text-home"
...
//               <button
//                 id="languageBox"
//                 className="dropbtn accuracy-text"
//                 style={{
//                   fontSize: "1em",
//                   textAlign: "left",
//                   paddingTop: "3px",
...
//               id="section_accuracy"
//               className="accuracy-text"
//               style={{ textAlign: "left", color: "black", fontSize: "larger" }}
//             >
//               | Score: 0
//             </p>
//           </div>
...
//               id="playSampleAudio"
//               href="#"
//               className="round-button disabled"
//               style={{
//                 color: "white",
//                 textAlign: "center",
//                 position: "absolute",
...
//               className="expanded accuracy-text"
//               style={{
//                 textAlign: "center",
//                 color: "black",
//                 position: "absolute",
...
//             >
//               Click on the bar on the right to generate a new sentence (please
//               use chrome web browser).
//             </p>
//             <p id="ipa_script" className="text-muted bigger-text ipa-text">
//               Before speaking, click on the mic button below to start recording
//               and then click again when you're done.
//             </p>
//             <p id="recorded_ipa_script" className="text-primary ipa-text">
//               On the left bottom you can choose the difficult. On the upper left
//               you can choose the language.
//             </p>
//             <p
//               id="translated_script"
//               className="text-muted medium-text ipa-text"
//             >
//               The corresponding IPA reading of each sentence will also be
//               displayed. If you never heard from IPA, you can check out this{" "}
//               <a
...
//                 playlist
//               </a>
//               . Try to get at least 690 points a day. Don't be shy! You can do
//               it :)
//             </p>
//           </div>
//         </div>
...
//             <button
//               id="buttonNext"
//               className="expanded button-next"
...
//               id="recordAudio"
//               href="#"
//               className="round-button-mic disabled"
//               style={{ color: "rgb(255, 255, 255)", textAlign: "center" }}
//             >
//               <i id="recordIcon" className="material-icons icon-text-mic">
//                 mic
//               </i>
//             </a>
//           </div>
...
//         id="radio-difficulty"
//         className="radio"
//         style={{ position: "fixed", top: "95%", left: "2%" }}
//       >
//         <button
//           type="radio"
//           id="lengthCat1"
