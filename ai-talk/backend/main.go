...
func CORSWrapper(h http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// If it's a preflight request, return 200 OK without further processing
		if r.Method == "OPTIONS" {
...
func doMain(ctx context.Context) error {
	...
	handler.HandleFunc("/api/ai-talk/start/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/conversation/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/upload/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/query/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/tts/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/remove/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
	...
	handler.HandleFunc("/api/ai-talk/examples/", CORSWrapper(func(w http.ResponseWriter, r *http.Request) {
